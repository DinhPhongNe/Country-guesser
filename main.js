...
function search(ele) {
  if(event.key === "Enter") {
    ...
    if(existingArr.includes(getNation)){
      misMatch.innerHTML = "Bạn đã đoán quốc gia này trước đây, thử quốc gia khác nào";
      ...
      //if the country name doesn't exist or in case of spelling mistake
        ...
        misMatch.innerHTML = "Đất nước không tồn tại, có thể là lỗi đánh máy của bạn";
        misMatch.style.display = "block";
        ele.value="";
      }
    }
